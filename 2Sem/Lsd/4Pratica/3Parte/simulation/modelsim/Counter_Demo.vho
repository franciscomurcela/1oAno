...
ENTITY 	Counter_Demo IS
	...
	SW : IN std_logic_vector(4 DOWNTO 3)
	);
END Counter_Demo;
...
SIGNAL ww_SW : std_logic_vector(4 DOWNTO 3);
...
-- Equation(s):
-- \inst|s_count~11_combout\ = (!\inst|s_count\(0) & !\SW[3]~input_o\)
...
-- Equation(s):
-- \inst|s_count[1]~5_combout\ = (\SW[4]~input_o\ & ((\inst|s_count\(1) & (!\inst|s_count[1]~4_cout\)) # (!\inst|s_count\(1) & ((\inst|s_count[1]~4_cout\) # (GND))))) # (!\SW[4]~input_o\ & ((\inst|s_count\(1) & (\inst|s_count[1]~4_cout\ & VCC)) # 
-- (!\inst|s_count\(1) & (!\inst|s_count[1]~4_cout\))))
-- \inst|s_count[1]~6\ = CARRY((\SW[4]~input_o\ & ((!\inst|s_count[1]~4_cout\) # (!\inst|s_count\(1)))) # (!\SW[4]~input_o\ & (!\inst|s_count\(1) & !\inst|s_count[1]~4_cout\)))
...
-- Equation(s):
-- \inst|s_count[2]~7_combout\ = ((\inst|s_count\(2) $ (\SW[4]~input_o\ $ (\inst|s_count[1]~6\)))) # (GND)
-- \inst|s_count[2]~8\ = CARRY((\inst|s_count\(2) & ((!\inst|s_count[1]~6\) # (!\SW[4]~input_o\))) # (!\inst|s_count\(2) & (!\SW[4]~input_o\ & !\inst|s_count[1]~6\)))
...
-- Equation(s):
-- \inst|s_count[3]~9_combout\ = \SW[4]~input_o\ $ (\inst|s_count[2]~8\ $ (!\inst|s_count\(3)))
