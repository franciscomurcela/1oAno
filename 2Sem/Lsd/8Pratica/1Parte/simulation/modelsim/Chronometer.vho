...
SIGNAL \control_unit|s_currentState.STOPPEDLAP~q\ : std_logic;
...
-- Equation(s):
-- \control_unit|s_currentState~9_combout\ = (\KEY[3]~input_o\ & ((\statop_debouncer|s_pulsedOut~q\ & ((\control_unit|s_currentState.LAPVIEW~q\))) # (!\statop_debouncer|s_pulsedOut~q\ & (\control_unit|s_currentState.STOPPEDLAP~q\))))
...
PORT MAP (
	dataa => \KEY[3]~input_o\,
	datab => \control_unit|s_currentState.STOPPEDLAP~q\,
...
\control_unit|s_currentState.STOPPEDLAP\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \control_unit|s_currentState.STOPPEDLAP~q\);

-- Location: LCCOMB_X94_Y16_N24
\control_unit|s_currentState~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \control_unit|s_currentState~7_combout\ = (\statop_debouncer|s_pulsedOut~q\ & (((\control_unit|s_currentState.STOPPEDLAP~q\)))) # (!\statop_debouncer|s_pulsedOut~q\ & (\control_unit|s_currentState.LAPVIEW~q\ & (!\laprst_debouncer|s_pulsedOut~q\)))
...
PORT MAP (
	...
	datac => \control_unit|s_currentState.STOPPEDLAP~q\,
	datad => \statop_debouncer|s_pulsedOut~q\,
...
-- \control_unit|s_currentState.STOPPEDLAP~q\))))
...
PORT MAP (
	...
	datac => \laprst_debouncer|s_pulsedOut~q\,
	datad => \control_unit|s_currentState.STOPPEDLAP~q\,
...
-- Equation(s):
-- \bcd_counter|count_proc~14_combout\ = (\control_unit|s_currentState.STOPPED~q\) # ((\pulse_generator|s_counter\(0)) # (\control_unit|s_currentState.STOPPEDLAP~q\))
...
-- Equation(s):
-- \control_unit|regEnb~1_combout\ = (!\control_unit|s_currentState.STOPPEDLAP~q\ & !\control_unit|s_currentState.LAPVIEW~q\)
