...
-- Equation(s):
-- \bit2|s~0_combout\ = \a[2]~input_o\ $ (\b[2]~input_o\ $ (((\a[1]~input_o\) # (\b[1]~input_o\))))
...
-- Equation(s):
-- \bit3|s~0_combout\ = \a[3]~input_o\ $ (\b[3]~input_o\ $ (((\a[2]~input_o\) # (\b[2]~input_o\))))
