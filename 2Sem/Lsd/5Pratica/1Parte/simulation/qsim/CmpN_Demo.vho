...
SIGNAL ww_input0 : std_logic_vector(8 DOWNTO 0);
SIGNAL ww_input1 : std_logic_vector(8 DOWNTO 0);
...
\input0[8]~input\ : cycloneive_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
